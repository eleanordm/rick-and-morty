<template>
<div class="lg:mt-36 flex justify-left md:justify-center p-10 sm:mt-10">
    <div class="w-[1000px] text-center md:text-left">
        <div class="font-zen text-blue text-xs md:text-sm">
            Hi there, my name is
        </div>
        <div class="font-zen text-pink text-3xl md:text-6xl mt-5">
            Eleanor Davis Mullen
        </div>
        <div class="font-zen text-[#f9bfdf] text-1xl md:text-4xl mt-2 opacity-90">
        ...
        <div class="mt-8 flex flex-col md:flex-row w-full items-center">
